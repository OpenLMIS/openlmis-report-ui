...
1. Fork/clone this repository from GitHub.
 ...
 ```shell
 git clone https://github.com/OpenLMIS/openlmis-report-ui.git
 ```
2. Develop w/ Docker by running `docker-compose run --service-ports report-ui`.
